...
minetest.register_craftitem("rangedweapons:stone_shuriken", {
	...
	RW_throw_capabilities = {
		throw_damage = {fleshy=3,knockback=8},
		throw_crit = 7,
		throw_critEffc = 2.1,
...
minetest.register_craftitem("rangedweapons:steel_shuriken", {
	...
	RW_throw_capabilities = {
		throw_damage = {fleshy=4,knockback=3},
		throw_crit = 8,
		throw_critEffc = 2.2,
...
minetest.register_craftitem("rangedweapons:golden_shuriken", {
	...
	RW_throw_capabilities = {
		throw_damage = {fleshy=3,knockback=10},
		throw_crit = 12,
		throw_critEffc = 2.5,
		throw_skill = {"throw_skill",35},
		throw_velocity = 25,
...
minetest.register_craftitem("rangedweapons:mese_shuriken", {
	...
	RW_throw_capabilities = {
		throw_damage = {fleshy=4,knockback=2},
		throw_crit = 9,
		throw_critEffc = 2.3,
...
minetest.register_craftitem("rangedweapons:diamond_shuriken", {
	...
	RW_throw_capabilities = {
		throw_damage = {fleshy=5,knockback=2},
		throw_crit = 10,
		throw_critEffc = 2.4,
