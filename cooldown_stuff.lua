...
--minetest.sound_play(itemstack:get_definition().loaded_sound, {player, max_hear_distance = 15})
...
--minetest.sound_play(itemstack:get_definition().load_sound, {player, max_hear_distance = 15})
minetest.sound_play(itemstack:get_definition().load_sound, {
                    pos = player:get_pos(),
                    max_hear_distance = 15,
                    gain = 1.0,
                    fade = 0.0,
